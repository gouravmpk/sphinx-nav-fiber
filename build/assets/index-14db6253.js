import{f as d,h as o,T as _,F as x,R as J,v as X,Y as Z,i as L,r as h,j as e,o as Fe,p as Le,q as we,l as z,t as ye,w as Pe,x as be,y as Se,z as ve,A as Me,B as Oe,C as Ge,D as Te,E as De,G as de,I as We}from"./index-2265ba41.js";import{B as P}from"./index-7ab45bda.js";import{u as E}from"./index-07a84897.js";import{T as Ye,a as M,b as Ue,F as ee,M as te,C as Ce,N as Ve,c as He,D as se,d as $e}from"./ChevronUpIcon-0738d68c.js";import{B,C as T,I as R,d as A,S as O,e as oe,F as ne}from"./react-toastify.esm-f7e54045.js";import{M as _e,a as ke,b as qe,c as Qe,d as Ke,e as Je}from"./index.esm-a328f591.js";import{P as G,I as D,a as re,F as ze}from"./Popover-3e5fa154.js";import{B as Xe,T as Ze}from"./index-9f520af7.js";import{A as Ee,u as $}from"./index-54e53ed7.js";import{P as Ne}from"./Popper-ed1a2459.js";import{C as Be}from"./CheckIcon-f41659c8.js";import{C as Ae}from"./ChevronDownIcon-e3ba8f35.js";import{S as et}from"./SettingsIcon-4794a6a5.js";import{T as tt,a as st}from"./index-3a4ffe6a.js";import"./useSlotProps-28897cf6.js";import"./InfoIcon-c8466471.js";const j=d(Ye)`
  && {
    color: ${o.white};
    border: none;
...
`,xt=d(D)`
  ...
  width: 100%;
`,ut=({data:t,canEdit:a=!1})=>{const r=L(s=>s.setSources),[i,p]=h.useState(""),f=async(s,l)=>{if(t!=null&&t.length)try{await Pe(s,l);const c=t==null?void 0:t.findIndex(m=>m.ref_id===s),g=[...t];g[c]={...g[c],source:l.source},r(g)}catch(c){console.warn(c)}},n=async s=>{if(!(!s||!(t!=null&&t.length))){p(s);try{await we(s),r(t==null?void 0:t.filter(l=>l.ref_id!==s))}catch(l){console.warn(l)}finally{p("")}}};return t!=null&&t.length?e.jsxs(te,{"aria-label":"a dense table",component:"table",id:"sources-table",size:"small",children:[e.jsx(le,{children:e.jsxs(M,{component:"tr",children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:"Type"}),e.jsx(j,{align:"left",children:"Source"}),a&&e.jsx(j,{align:"left"}),e.jsx(j,{className:"empty"})]})}),e.jsx(He,{component:"tbody",children:t==null?void 0:t.map(s=>e.jsxs(ie,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{align:"left",children:I[s.source_type]}),e.jsx(j,{align:"left",children:e.jsx(ft,{condition:a,wrapper:l=>e.jsx(mt,{id:s.ref_id,onSave:c=>f(s.ref_id,{source:c,source_type:s.source_type}),value:s.source,children:l}),children:s.source_type===X||s.source_type===Z||s.source_type===J?e.jsxs(e.Fragment,{children:[s.source_type===X&&e.jsxs(U,{href:`${Ie}/${s.source}`,target:"_blank",children:["@",s.source]}),s.source_type===Z&&e.jsx(U,{href:`${s.source}${s.source.includes("?")?"&":"?"}open=system`,target:"_blank",children:s.source}),s.source_type===J&&e.jsx(U,{href:s.source,target:"_blank",children:s.source})]}):e.jsx("div",{children:s.source})})}),a&&e.jsx(j,{align:"left",children:e.jsx("div",{className:"delete-wrapper",id:`delete-${s.source}`,children:i===s.ref_id?e.jsx(T,{color:o.white}):e.jsx(Ce,{message:"Are you sure ?",onConfirm:()=>n(s.ref_id),children:e.jsx(N,{className:"centered",children:e.jsx(qe,{})})})})}),e.jsx(j,{className:"empty"})]},s.source))})]}):e.jsxs(jt,{children:[e.jsx(Ve,{}),e.jsx(_,{className:"text",children:"There is not any results for selected filters"})]})};function ft({condition:t,wrapper:a,children:r}){return t?a(r):r}const mt=({value:t,onSave:a,id:r,children:i})=>{const[p,f]=h.useState(!1),[n,s]=h.useState(t),[l,c]=h.useState(!1),g=async()=>{if(r){c(!0);try{await a(n),f(!1)}catch(m){console.warn(m)}finally{c(!1)}}};return e.jsx("div",{children:p?e.jsxs(gt,{direction:"row",children:[e.jsx(Xe,{className:"editable-cell__input",name:"cell-input",onChange:m=>s(m),value:n}),e.jsx(N,{align:"center",justify:"center",children:l?e.jsx(T,{}):e.jsx(Qe,{onClick:g})}),e.jsx(N,{align:"center",className:"secondary",justify:"center",onClick:()=>f(!1),children:e.jsx(Ke,{})})]}):e.jsxs(wt,{direction:"row",children:[i,e.jsx(N,{onClick:()=>f(!0),children:e.jsx(Je,{size:20})})]})})},gt=d(x)`
  display: flex;
  width: 250px;
...
`,Xt=({topic:t,onClick:a})=>{const[r,i]=$(l=>[l.ids,l.total]),[p,f]=h.useState(!1),n=t.date_added_to_graph.toString(),s=async(l,c)=>{f(!0);try{await Te(l,{muted_topic:c}),$.setState({ids:r.filter(g=>g!==l),total:i-1})}catch(g){console.warn(g)}};return e.jsxs(ie,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:t.topic}),e.jsx(j,{children:t.edgeCount}),e.jsx(j,{children:t.edgeList.join(", ")}),e.jsx(j,{children:e.jsx("span",{children:new Date(Number(n)*1e3).toDateString()})}),e.jsx(j,{className:"cell-center",children:e.jsx(x,{direction:"row",justify:"space-between",children:e.jsx("div",{className:"approve-wrapper",children:p?e.jsx(T,{color:o.white,size:16}):e.jsx(e.Fragment,{children:t.muted_topic?e.jsx(je,{className:"centered",onClick:()=>s(t.ref_id,!1),children:e.jsx(_e,{color:o.primaryGreen,fontSize:24})}):e.jsx(je,{className:"centered",onClick:()=>s(t.ref_id,!0),children:e.jsx(ke,{color:o.primaryRed,fontSize:24})})})})})}),e.jsx(j,{children:e.jsx(R,{onClick:l=>a(l,t.ref_id),children:e.jsx(et,{})})})]},t.topic)},je=d(x)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,ss=()=>{const[t,a]=h.useState(!1),[r,i,p,f,n,s,l]=$(C=>[C.data,C.ids,C.total,C.setTopics,C.filters,C.setFilters,C.terminate]),{open:c}=E("editTopic"),{open:g}=E("mergeTopic"),{open:m}=E("addEdge"),[w,y]=h.useState(null),b={editTopic:c,mergeTopic:g,addEdge:m},u=h.useRef([]);h.useEffect(()=>{i.length&&(u.current=i)},[i]),h.useEffect(()=>{(async()=>{try{a(!0),await f()}catch{console.error("err")}finally{a(!1)}})()},[f,n]);const v=async()=>{try{a(!0),s({page:n.page+1})}catch(C){console.error("Error loading more data:",C)}finally{a(!1)}};h.useEffect(()=>()=>{l()},[l]);const S=C=>{s({sortBy:C})},k=()=>{y(null)},Re=(C,ce)=>{r&&(y(r[C]),typeof b[ce]=="function"&&b[ce]())};return e.jsxs(e.Fragment,{children:[e.jsxs(os,{direction:"column",justify:"flex-end",children:[e.jsxs(ae,{align:"flex-start",direction:"row",justify:"space-between",children:[e.jsx(_,{className:"title",children:"Topics"}),e.jsxs(B,{disabled:t,onClick:()=>s({muted:!n.muted}),size:"medium",children:[n.muted?"Show Unmuted":"Show Muted",t&&e.jsx(T,{color:o.BLUE_PRESS_STATE,size:10})]})]}),e.jsxs(rs,{children:[e.jsx(Ht,{}),e.jsx(qt,{currentFilter:n.sortBy,onChangeFilter:S})]}),e.jsx(ns,{align:"center",justify:t&&!r?"center":"flex-start",children:t&&!r?e.jsx(T,{color:o.white}):e.jsxs(e.Fragment,{children:[e.jsx(es,{onTopicEdit:Re,showMuted:n.muted}),p>i.length?e.jsxs(B,{className:"load-more",disabled:t,onClick:v,children:["Load more",t&&e.jsx(T,{color:o.BLUE_PRESS_STATE,size:10})]}):null]})})]}),w&&e.jsx(Vt,{onClose:k,topic:w}),w&&e.jsx(Pt,{onClose:k,topic:w}),w&&e.jsx(Rt,{onClose:k,topic:w})]})},os=d(x)`
  flex: 1;
...
`,rs=d(x).attrs({direction:"row",align:"center",justify:"space-between"})`
  padding: 0 36px;
  margin-bottom: 32px;
`,q=t=>{const{children:a,value:r,index:i,...p}=t;return r===i?e.jsx(as,{"aria-labelledby":`simple-tab-${i}`,hidden:r!==i,id:`simple-tabpanel-${i}`,role:"tabpanel",...p,children:a}):null};function Q(t){return{id:`simple-tab-${t}`,"aria-controls":`simple-tabpanel-${t}`}}const is=()=>{const[t,a]=h.useState(0),[r]=be(f=>[f.isAdmin]),[i]=We(f=>[f.queuedSourcesFlag]),p=(f,n)=>{a(n)};return e.jsxs(cs,{direction:"column",children:[e.jsxs(ls,{"aria-label":"sources tabs",onChange:p,value:t,children:[e.jsx(K,{disableRipple:!0,label:"Sources table",...Q(0)}),r&&i?e.jsx(K,{color:o.white,disableRipple:!0,label:"Queued sources",...Q(1)}):null,r&&e.jsx(K,{color:o.white,disableRipple:!0,label:"Topics",...Q(1)})]}),e.jsx(q,{index:0,value:t,children:e.jsx(yt,{})}),e.jsx(q,{index:1,value:t,children:e.jsx(at,{})}),e.jsx(q,{index:2,value:t,children:e.jsx(ss,{})})]})},ls=d(tt)`
  && {
