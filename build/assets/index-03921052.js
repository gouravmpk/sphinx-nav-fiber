import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-2265ba41.js";import{B as F}from"./index-7ab45bda.js";import{u as M}from"./index-07a84897.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-f7e54045.js";import{B as f,T as R,a as L}from"./index-3a4ffe6a.js";import{T as x}from"./index-9f520af7.js";import"./useSlotProps-28897cf6.js";import"./index.esm-a328f591.js";import"./InfoIcon-c8466471.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
